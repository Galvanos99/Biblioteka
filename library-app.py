                            ...
                            if changed_user_id.lower() == "esc":
                                ...
                                try:
                                    ...
                                    if changed_user:
                                        ...
                                        print(
                                            f"Aktywowano użytkownika o ID {changed_user_id}." if activated else f"Dezaktywowano użytkownika o ID {changed_user_id}.")

                                        # Dane użytkownika w formie listy
                                        user_data = [
                                            [changed_user.id, changed_user.username, changed_user.name,
                                             changed_user.surname,
                                             "Tak" if changed_user.is_admin else "Nie",
                                             "Tak" if changed_user.activated else "Nie",
                                             "Tak" if changed_user.blocked else "Nie"]
                                        ]
                            ...
                            if changed_user_id.lower() == "esc":
                                ...
                                try:
                                    ...
                                    if changed_user:
                                        ...
                                        print(
                                            f"Zablokowano użytkownika o ID {changed_user_id}." if blocked else f"Odblokowano użytkownika o ID {changed_user_id}.")
